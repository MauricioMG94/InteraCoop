...
namespace InteraCoop.Backend.Data
{
    public class SeedDb
    {
        ...
        private async Task CheckInteractionsAsync()
        {
            ...
            {
                _context.Interactions.Add(new Interaction { InteractionType = "Visita a cliente", InteractionCreationDate = DateTime.Now, StartDate = new DateTime(2024, 06, 08), EndDate = new DateTime(2024, 06, 08), Address = "Home", ObservationsInteraction = "Cliente mostró interés en la tarjeta de crédito Visa. Se discutieron los beneficios y el proceso de aplicación.", Office = "Home", AuditDate = new DateTime(2024, 06, 08), AuditUser = "Harol", ClientId = 1 });
                _context.Interactions.Add(new Interaction { InteractionType = "Visita a cliente", InteractionCreationDate = DateTime.Now, StartDate = new DateTime(2024, 06, 08), EndDate = new DateTime(2024, 06, 08), Address = "Oficina", ObservationsInteraction = "Cliente interesado en el crédito hipotecario del Banco X. Se revisaron los términos y la tasa de interés.\"", Office = "Home", AuditDate = new DateTime(2024, 06, 08), AuditUser = "Ivan", ClientId = 2 });
                _context.Interactions.Add(new Interaction { InteractionType = "Visita a cliente", InteractionCreationDate = DateTime.Now, StartDate = new DateTime(2024, 06, 08), EndDate = new DateTime(2024, 06, 08), Address = "Modulo 3", ObservationsInteraction = "Se discutió el seguro vehicular con el cliente. Cliente pidió más información sobre la cobertura.", Office = "Home", AuditDate = new DateTime(2024, 06, 08), AuditUser = "Ivan", ClientId = 3 });
                _context.Interactions.Add(new Interaction { InteractionType = "Visita a cliente", InteractionCreationDate = DateTime.Now, StartDate = new DateTime(2024, 06, 08), EndDate = new DateTime(2024, 06, 08), Address = "Home", ObservationsInteraction = "Se ofreció el crédito de consumo del Banco V. Cliente pidió tiempo para revisar los términos.", Office = "Home", AuditDate = new DateTime(2024, 06, 08), AuditUser = "Cristian", ClientId = 4 });
                _context.Interactions.Add(new Interaction { InteractionType = "Visita a cliente", InteractionCreationDate = DateTime.Now, StartDate = new DateTime(2024, 06, 08), EndDate = new DateTime(2024, 06, 08), Address = "Modulo 1", ObservationsInteraction = "Cliente mostró interés en la cuenta de ahorros del Banco Z. Se discutieron las ventajas y el proceso de apertura.", Office = "Home", AuditDate = new DateTime(2024, 06, 08), AuditUser = "Ivan", ClientId = 5 });
                _context.Interactions.Add(new Interaction { InteractionType = "Visita en oficina", InteractionCreationDate = DateTime.Now, StartDate = new DateTime(2024, 06, 08), EndDate = new DateTime(2024, 06, 08), Address = "Home", ObservationsInteraction = "Se discutieron los beneficios del fondo de pensiones GHI. Cliente interesado en más detalles.", Office = "Home", AuditDate = new DateTime(2024, 06, 08), AuditUser = "Harol", ClientId = 6 });
                _context.Interactions.Add(new Interaction { InteractionType = "Visita en oficina", InteractionCreationDate = DateTime.Now, StartDate = new DateTime(2024, 06, 08), EndDate = new DateTime(2024, 06, 08), Address = "Modulo 2", ObservationsInteraction = "Se ofreció el crédito de consumo del Banco V. Cliente pidió tiempo para revisar los términos.", Office = "Home", AuditDate = new DateTime(2024, 06, 08), AuditUser = "Ivan", ClientId = 7 });
                _context.Interactions.Add(new Interaction { InteractionType = "Visita en oficina", InteractionCreationDate = DateTime.Now, StartDate = new DateTime(2024, 06, 08), EndDate = new DateTime(2024, 06, 08), Address = "Modulo 4", ObservationsInteraction = "Cliente interesado en la tarjeta de débito del Banco W. Se explicó el proceso de emisión y las ventajas.\"", Office = "Home", AuditDate = new DateTime(2024, 06, 08), AuditUser = "Cristian", ClientId = 8 });
                ...
                _context.Interactions.Add(new Interaction { InteractionType = "Visita en oficina", InteractionCreationDate = DateTime.Now, StartDate = new DateTime(2024, 06, 08), EndDate = new DateTime(2024, 06, 08), Address = "Home", ObservationsInteraction = "Cliente consultó sobre el seguro de vida ABC. Se proporcionaron detalles sobre las pólizas disponibles.", Office = "Home", AuditDate = new DateTime(2024, 06, 08), AuditUser = "Ivan", ClientId = 10 });
                _context.Interactions.Add(new Interaction { InteractionType = "Llamada entrante", InteractionCreationDate = DateTime.Now, StartDate = new DateTime(2024, 06, 08), EndDate = new DateTime(2024, 06, 08), Address = "Oficina", ObservationsInteraction = "Se discutieron los beneficios del fondo de pensiones GHI. Cliente interesado en más detalles.", Office = "Home", AuditDate = new DateTime(2024, 06, 08), AuditUser = "Cristian", ClientId = 11 });
                _context.Interactions.Add(new Interaction { InteractionType = "Llamada entrante", InteractionCreationDate = DateTime.Now, StartDate = new DateTime(2024, 06, 08), EndDate = new DateTime(2024, 06, 08), Address = "Modulo 1", ObservationsInteraction = "Cliente interesado en el fondo de inversión XYZ. Se revisaron los términos y la tasa de retorno esperada.", Office = "Home", AuditDate = new DateTime(2024, 06, 08), AuditUser = "Harol", ClientId = 12 });
                _context.Interactions.Add(new Interaction { InteractionType = "Llamada entrante", InteractionCreationDate = DateTime.Now, StartDate = new DateTime(2024, 06, 08), EndDate = new DateTime(2024, 06, 08), Address = "Oficina", ObservationsInteraction = "Se discutió el seguro vehicular con el cliente. Cliente pidió más información sobre la cobertura.", Office = "Home", AuditDate = new DateTime(2024, 06, 08), AuditUser = "Cristian", ClientId = 1 });
                ...
                _context.Interactions.Add(new Interaction { InteractionType = "Llamada entrante", InteractionCreationDate = DateTime.Now, StartDate = new DateTime(2024, 06, 08), EndDate = new DateTime(2024, 06, 08), Address = "Home 3", ObservationsInteraction = "Cliente interesado en la tarjeta de débito del Banco W. Se explicó el proceso de emisión y las ventajas.\"", Office = "Home", AuditDate = new DateTime(2024, 06, 08), AuditUser = "Ivan", ClientId = 3 });
                _context.Interactions.Add(new Interaction { InteractionType = "Visita a cliente", InteractionCreationDate = DateTime.Now, StartDate = new DateTime(2024, 06, 08), EndDate = new DateTime(2024, 06, 08), Address = "Home", ObservationsInteraction = "Cliente mostró interés en la cuenta de ahorros del Banco Z. Se discutieron las ventajas y el proceso de apertura.", Office = "Home", AuditDate = new DateTime(2024, 06, 08), AuditUser = "Ivan", ClientId = 4});
                _context.Interactions.Add(new Interaction { InteractionType = "Visita a cliente", InteractionCreationDate = DateTime.Now, StartDate = new DateTime(2024, 06, 08), EndDate = new DateTime(2024, 06, 08), Address = "Oficina", ObservationsInteraction = "Cliente mostró interés en la tarjeta de crédito Visa. Se discutieron los beneficios y el proceso de aplicación.", Office = "Home", AuditDate = new DateTime(2024, 06, 08), AuditUser = "Cristian", ClientId = 5 });
                _context.Interactions.Add(new Interaction { InteractionType = "Visita a cliente", InteractionCreationDate = DateTime.Now, StartDate = new DateTime(2024, 06, 08), EndDate = new DateTime(2024, 06, 08), Address = "Modulo 1", ObservationsInteraction = "Cliente interesado en el crédito hipotecario del Banco X. Se revisaron los términos y la tasa de interés.\"", Office = "Home", AuditDate = new DateTime(2024, 06, 08), AuditUser = "Harol", ClientId = 6 });
                _context.Interactions.Add(new Interaction { InteractionType = "Visita a cliente", InteractionCreationDate = DateTime.Now, StartDate = new DateTime(2024, 06, 08), EndDate = new DateTime(2024, 06, 08), Address = "Oficina", ObservationsInteraction = "Cliente consultó sobre el seguro de vida ABC. Se proporcionaron detalles sobre las pólizas disponibles.", Office = "Home", AuditDate = new DateTime(2024, 06, 08), AuditUser = "Cristian", ClientId = 7 });
                _context.Interactions.Add(new Interaction { InteractionType = "Visita a cliente", InteractionCreationDate = DateTime.Now, StartDate = new DateTime(2024, 06, 08), EndDate = new DateTime(2024, 06, 08), Address = "Modulo 1", ObservationsInteraction = "Cliente interesado en el fondo de inversión XYZ. Se revisaron los términos y la tasa de retorno esperada.", Office = "Home", AuditDate = new DateTime(2024, 06, 08), AuditUser = "Harol", ClientId = 8 });
                await _context.SaveChangesAsync();
            }
        }
