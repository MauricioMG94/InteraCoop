    ...
    public class SeedDb
    {
        ...
        private async Task CheckInteractionsAsync()
        {
            ...
            if (!_context.Interactions.Any())
            {
                ...
                {
                 new Client { CityId = 20334, Name = "Jorge Garcia", Document = 123456, DocumentType = DocumentType.CC.ToString(), Telephone = 3005378, Address = "Cll 80 #110-14", RegistryDate = new DateTime(2024, 04, 27), AuditUpdate = new DateTime(2024, 04, 27), AuditUser = "System" }
                };
